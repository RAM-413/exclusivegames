...
const Ellos = () => {
    ...
    return (
        <>
            <div className='relative z-[50]' id='oferates'>
                <div className=' mx-auto container  max-w-[1140px] mt-[60px] sm:mt-[150px] px-3'>
                    ...
                    <div className='grid grid-cols-1 relative z-[50] sm:mt-[45px] mt-[30px] md:mt-[60px] mb-[40px] sm:grid-cols-2 lg:grid-cols-3 w-full lg:gap-5 xl:gap-[24px]' >
