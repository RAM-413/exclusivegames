...
import ghar from '../assets/images/box-1img.webp'
import Common2 from './Common2.jsx';
import { Righttick } from './Icon.jsx';
import Boxelipse from "../assets/images/box-backelipse.png"
const Box1 = () => {
    return (
        <>
            <div className='mx-4 relative z-[1]'>
                <img className=' absolute top-[22%] left-[4%]' src={Boxelipse} alt="Boxelipse" />
                <p className='text-white text-[25px] sm:text-[48px] leading-[57.6px] font-["anton"] md:mb-3 mb-0
                 text-center font-[400] md:mt-[100px] sm:mt-[70px] mt-[40px] lg:mt-[150px]'>Nuestras ofertas</p>
                ...
                <div className=' px-3 mx-auto max-w-[1140px] max-w-lg-mx-3 border-[#828F93] sm:mt-[40px] mt-[25px] md:mt-[60px] border-[1px] rounded-[16px] bg-[#062027] md:p-[57px_40px_32px_0] sm:p-[40px_40px_28px_0] p-[30px_36px_24px_0]'>
                    <div className='flex flex-row flex-wrap -mx-3 justify-center items-center'>
                        <div className='lg:w-1/2 px-3'>
                            <img src={ghar} alt="img" className='w-full relative z-[3]' />
                        </div>
                        <div className='lg:w-1/2 px-3'>
