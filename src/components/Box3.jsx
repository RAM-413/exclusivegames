    ...
    return (
        <>
            <div className='relative z-[1]'>
                ...
                <img src={ellipse2} alt='image' className='z-[-1] animate-pulse absolute  right-0'></img>
                <img src={ellipse1} alt='image' className='z-[-1] animate-pulse absolute top-[-110%] left-[-10%] max-md:hidden'></img>
